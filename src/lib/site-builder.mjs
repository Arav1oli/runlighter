    ...
    '@graph':[
      {
        ...
        serviceType:['Business process automation','Workflow automation','AI automation consulting','External marketing implementation','Lead generation management','Content and publishing systems','Marketing measurement and reporting'],
