...
(async () => {
  ...
  composites.push({
    input: Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="1840" height="120"><text x="32" y="58" fill="#fbf8f1" font-family="Arial" font-size="42" font-weight="700">Run Lighter campaign v3</text><text x="32" y="94" fill="#b7c1aa" font-family="Arial" font-size="22">10 original 4:5 concepts | July 2026</text></svg>`),
    left: 0,
    top: 0,
  });
  await sharp({ create: { width, height, channels: 3, background: '#253029' } })
    ...
    .toFile(path.join(__dirname, 'campaign-v3-contact-sheet.png'));
  console.log('Rendered campaign-v3-contact-sheet.png');
})();
