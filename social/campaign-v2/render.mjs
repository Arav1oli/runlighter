...
const posts = [
  {file:'01-ai-selective.png', lines:['AI DOESN\u2019T','BELONG','EVERYWHERE'], fg:'#29312c', grad:['#fbf8f1','0.98','#fbf8f1','0.82'], markBg:'#344137', markFg:'#fbf8f1', rule:'#587664', size:104, y:158},
  {file:'02-competitors.png', lines:['YOUR COMPETITORS','ARE ALREADY','AUTOMATING'], fg:'#fbf8f1', grad:['#0c141b','0.88','#0c141b','0.28'], markBg:'#fbf8f1', markFg:'#344137', rule:'#718069', size:98, y:154},
